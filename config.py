...
class Config(object):
    ...
    BLOB_CONNECTION_STRING = os.environ.get('BLOB_CONNECTION_STRING') or 'HU6ZcEIeJktERfbrrUIthdQD7n2AXDicoG+S2eXVJmgkw3QuG18oRKZJz72LLcIN9I8uKivGU4Hi5dJdDqdLLQ=='
